      ...
      <div>
        ...
        <div className="card">
          ...
          <ul style={{ paddingLeft: '1.2rem', color: 'var(--text-muted)', fontSize: '0.92rem' }}>
            <li>10 random questions from a pool of scenario-based items (including frame timing)</li>
            <li>Questions test tricky pairs: Clearance vs Recovery, Foul vs Referee, Block vs Save, frame offsets, and more</li>
